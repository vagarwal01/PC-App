...
//        earthVid.setMediaController(mediaController);
        ...
        btnClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MediaPlayer mediaPlayer = MediaPlayer.create(Petrol.this, R.raw.stop);
                mediaPlayer.start();
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent i = new Intent(Petrol.this, MyCars.class);
                        Toast.makeText(Petrol.this, "Car Stops", Toast.LENGTH_SHORT).show();
                        startActivity(i);
                        finish();
                    }
                }, TIME_OUT);
                ...
                countDownTimer = new CountDownTimer(startTime, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        new Handler().postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                Intent i = new Intent(Petrol.this, start_stop.class);
